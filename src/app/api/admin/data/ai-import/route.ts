...
⚠️ 职称（title）字段只能填写专业技术职称，绝对不能填写行政职务！

✅ 正确的职称示例（可映射到标准等级）：
- **院士级（hourlyRate: 1500）**：院士、中国科学院院士、中国工程院院士
   
- **正高（hourlyRate: 1000）**：教授、正教授、研究员、正高级工程师、正高级经济师、主任医师、主任药师、编审、译审、教授级高级工程师、国家级教练、特级教师（正高待遇）、研究馆员（一级~四级）
   
- **副高（hourlyRate: 500）**：副教授、副研究员、高级工程师、高级经济师、高级会计师、副主任医师、高级讲师、高级技师、副研究馆员、副编审
   
- **中级（hourlyRate: 500）**：讲师、助理研究员、工程师、经济师、会计师、主治医师、技师、馆员、编辑
   
- **初级（hourlyRate: 500）**：助教、助理工程师、助理经济师、医师、助理馆员、助理编辑
...
**处理规则**：
1. 如果文本中只有行政职务（如"王XX 院长"），没有专业技术职称：
   - title字段填写"其他"（hourlyRate: 500）
2. 如果文本中同时有职称和职务（如"李XX 教授、院长"）：
   - title字段填写职称对应的等级（如"正高"）
3. 不确定是否为职称时，填写"其他"
...
- 即使原文没有提到课时费，也必须根据职称自动计算并填充hourlyRate字段！`,
