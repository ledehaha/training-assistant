...
1. 首先识别原始职称，然后映射到标准等级：
   - **院士**：院士、中国科学院院士、中国工程院院士 → 标准等级：院士，hourly_rate: 1500
   
   - **正高**：教授、正教授、研究员、正高级工程师、正高级经济师、正高级会计师、主任医师、主任药师、主任技师、编审、译审、教授级高级工程师、国家级教练、特级教师（正高待遇）→ 标准等级：正高，hourly_rate: 1000
   
   - **副高**：副教授、副研究员、高级工程师、高级经济师、高级会计师、高级农艺师、副主任医师、副主任药师、副主任技师、副编审、副译审、高级讲师、高级实习指导教师、中小学高级教师、省级教练、特级教师（副高待遇）、高级技师 → 标准等级：副高，hourly_rate: 500
   
   - **中级**：讲师、助理研究员、工程师、经济师、会计师、农艺师、主治医师、主管药师、主管技师、编辑、翻译、中小学一级教师、一级教练、技师 → 标准等级：中级，hourly_rate: 500
   
   - **初级**：助教、助理工程师、助理经济师、助理会计师、助理农艺师、医师、药师、检验师、助理编辑、助理翻译、中小学二级教师、二级教练、高级工 → 标准等级：初级，hourly_rate: 500
   
   - **其他**：无法识别的职称、无职称信息 → 标准等级：其他，hourly_rate: 500

2. 识别技巧：
   - 注意职称中的"高级"≠"正高"，如"高级工程师"通常指副高
   - 注意"教授级高级工程师"是正高，"高级工程师"是副高
   - 注意技能人员职称：高级技师=副高，技师=中级
   - 如果提到"国家级"、"享受国务院津贴"等，通常是正高或更高
   - 如果提到"省/部级专家"，通常是副高或以上
